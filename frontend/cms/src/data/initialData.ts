...
export const INITIAL_DOCTORS: Doctor[] = [
  {
    ...
    location: 'Dr. Rajneesh Kant Clinic – Mumbai (Bandra West) & Patna (Boring Road)',
...
export const INITIAL_CMS_USERS: CMSUser[] = [
  {
    ...
    email: 'dr.rajneesh@drrajneeshkant.in',
    role: 'doctor',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Rajneesh',
  ...
  },
  {
    ...
    email: 'reception@drrajneeshkant.in',
    role: 'receptionist',
